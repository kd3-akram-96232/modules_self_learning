...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=onlinefoodordering_db;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Food>(entity =>
        {
            entity.HasKey(e => e.Fid).HasName("PK__Food__D9908D64F6230B8F");
        ...
        {
            entity.HasKey(e => e.Oid).HasName("PK__Orders__C2FFCF13082B3F81");
        ...
        {
            entity.HasKey(e => e.Uid).HasName("PK__Users__DD70126476ED1B87");
